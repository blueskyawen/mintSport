<template>
	<page-bg>
		<view class="add-plan">
			<view class="head">
				<view class="title">定制我的计划</view>
				<view class="text">选择目标, 生成专属每日安排</view>
			</view>
			...
			<view class="submit-box">
				<u-button type="primary" :disabled="isLoading" :loading="isLoading" color="#72D1A8" @click="submit">生成专属计划</u-button>
			</view>
		</view>
	</page-bg>
</template>
